...
class TripRequest(BaseModel):
    ...
    # 编辑行程专用字段：有值时走 edit_plan 分支，否则走 new_plan 分支
    existing_plan: Optional[dict] = Field(default=None, description="已有行程 JSON，编辑时传入")
    edit_instruction: Optional[str] = Field(default=None, description="用户的修改意图，如'把第二天改轻松一点'")
